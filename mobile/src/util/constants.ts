...
export const exerciseDict: Record<string, TabataExercise> = {
    'windshield-wipers': {
        _id: 'wipers', name: 'Windshield Wipers', types: ['Abs'], description: 'Rotate legs side to side in a controlled motion.', difficulty: 'Advanced', equipment: [],
    },
    'inch-worms': {
    ...
    'burpee-push-ups': {
        _id: 'burpee-push-ups', name: 'Burpee Push-Ups', types: ['Cardio', 'Abs', 'Upper Body'], description: 'Perform a burpee with a push-up at the bottom.', difficulty: 'Intermediate', equipment: [],
    },
    'running-in-place': {
